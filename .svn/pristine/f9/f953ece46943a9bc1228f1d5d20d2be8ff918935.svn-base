	...
	<div id="riskfileupload" class="dialog-v">
    	<form id="riskfileuploadForm" action="riskfileupload" method="POST" enctype="multipart/form-data" class="styleForm">
    			...
    			<table width="100%" cellpadding="1" cellspacing="1">        	
                    ...
                    <tr>
                        <td class="form_head">
                           <span id="risk_assessment"> Risk Assessment </span>
                        </td>
                   </tr>
               		<!--end:heading--> 
               		<tr>
               		...
               		<tr>	
						<td>
							<label for="riskAssRequired" id="risk_assessment_req"> Risk Assessment Required :</label> 
							
							<div>
							<div style="float:left; padding-right:1.0em">
								<label id="risk_req_yes" style="font-weight:normal;">Yes</label> 				
								<input style="margin:0.3em 0 0 0.7em" type="radio" name="riskAssRequired" value="y">
							</div>
							<div style="float:left">
								<label id="risk_req_no" style="font-weight:normal;">No</label> 				
					            <input style="margin:0.3em 0 0 0.7em" type="radio" name="riskAssRequired" value="n">
							</div>			
							</div>
						</td>
					</tr>
				...
				<table width="100%" cellpadding="1" cellspacing="1">   
					...
					<tr>
                        <td>
                            <span id="risk_assessment_ref">Risk Assessment Reference</span>
                   ...
                   <tr>
                    ...
                    <tr>
                    	<td>
                        	<span id="risk_filename">File Name</span>
                    ...
                    <!--end:file upload-->
                     <tr>
                     	<td class="mssdisplay">
                        	<span class="msgcolor">*</span><span id="msg_upload_limit">File upload limit is 2MB</span>
                        </td>
                        </tr>
        		...
        		<div style="clear:both; margin:0.5em 0.5em 0 0.5em;">	
        			<label for="riskAssCompleted" id="risk_assessment_completed">Assessment Completed: </label> 	
					<div style="float:left; padding-right:1.5em">
						<label id="risk_comp_yes" style="font-weight:normal;">Yes</label> 				
						<input style="margin:0.3em 0 0 0.7em" type="radio" name="riskAssCompleted" value="y">
					</div>
					<div style="float:left">
						<label  id="risk_comp_no"  style="font-weight:normal;">No</label> 				
                		<input style="margin:0.3em 0 0 0.7em" type="radio" name="riskAssCompleted" value="n">
					</div>
				</div>
		</div>		
