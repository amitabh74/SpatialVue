	...
	<form class="cmxform" id="forgotpasswordform" onsubmit="return false;">
		<div id="signup-form">
			<ul id="company-info" class="section">
				...
				<input type="hidden" id="hidLang" name="hidLang" value="<%=lang%>" />
