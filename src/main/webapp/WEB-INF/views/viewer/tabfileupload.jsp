    	...
    	<form id="tabfileuploadForm" action="tabfileupload" method="POST" enctype="multipart/form-data" >
	     <table id="projectDetails" class="styleForm inputint">
			<tbody id="projectGeneralBody">
				...
				<div class="formRow">
				<label id="lbl_selectLayer">Select Layer:</label>
				...
				<div class="formRow">
				<label id="lbl_selectFile">Select File:</label>
				...
				<div align="right">
				<input id="btnupload" class="btnUpload" type="submit" style="margin-top:5px; height:25px;" value="Upload"/> 
				</div>
